...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'your-fallback-secret-key-for-development-only') 
...
if not DEBUG:
    ...
    PROD_DOMAIN = os.environ.get('PROD_DOMAIN', 'controladoria.saquarema.rj.gov.br')
